...
def main():
    ...
    parser.add_argument("-m","--model_name",help="the model name", type=str, default='sccnn_node_no_b2_no_edge_to_node')
    ...
    if model_name in ['sccnn_node_no_tri','sccnn_node_no_b2','sccnn_node_no_b2_no_node_to_node','sccnn_node_no_b2_no_node_to_edge','sccnn_node_no_b2_no_edge_to_edge','sccnn_node_no_b2_no_edge_to_node']:
