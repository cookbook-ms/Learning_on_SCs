...
def main():
    ...
    parser.add_argument("-m","--model_name",help="the model name", type=str, default='sccnn_node_sc_1_no_n_to_e')
    ...
    if args.model_name in ['sccnn_node_sc_1_no_n_to_e','sccnn_node_sc_1_no_n_to_n','sccnn_node_sc_1_no_e_to_e','sccnn_node_sc_1_no_e_to_n']:
