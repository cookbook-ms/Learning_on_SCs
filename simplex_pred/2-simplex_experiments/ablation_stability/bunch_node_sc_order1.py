...
def main():
    ...
    parser.add_argument("-m","--model_name",help="the model name", type=str, default='bunch_node_sc_1')
    ...
    if args.model_name in ['bunch_node_sc_1']:
    ...
    if model_name in ['bunch_node_sc_1']:
