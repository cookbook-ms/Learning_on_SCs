...
'''no differntiating the lower and upper adjacency in H1'''    
...
class sccnn_conv_no_x0(nn.Module):
    def __init__(self, F_in, F_out, b1, b2, l0, l1l, l1u, l2, d1,d2,d3,d5, k00,k0p,k1n,k11,k12,k1p,k2n,k22, sigma):
        """
        F_in: number of input features per layer 
        F_out: number of output features per layer
        ...
        n: stands for negative, denoting the lower simplex order
        """
        super(sccnn_conv_no_x0, self).__init__()
        self.F_in = F_in
        self.F_out = F_out 
        self.B1 = b1 
        self.B2 = b2
...
class sccnn_conv_no_x1(nn.Module):
    def __init__(self, F_in, F_out, b1, b2, l0, l1l, l1u, l2, d1,d2,d3,d5, k00,k0p,k1n,k11,k12,k1p,k2n,k22, sigma):
        """
        F_in: number of input features per layer 
        F_out: number of output features per layer
        ...
        n: stands for negative, denoting the lower simplex order
        """
        super(sccnn_conv_no_x1, self).__init__()
        self.F_in = F_in
        self.F_out = F_out 
        self.B1 = b1 
        self.B2 = b2
...
class sccnn_conv_no_x2(nn.Module):
    def __init__(self, F_in, F_out, b1, b2, l0, l1l, l1u, l2, d1,d2,d3,d5, k00,k0p,k1n,k11,k12,k1p,k2n,k22, sigma):
        """
        F_in: number of input features per layer 
        F_out: number of output features per layer
        ...
        n: stands for negative, denoting the lower simplex order
        """
        super(sccnn_conv_no_x2, self).__init__()
        self.F_in = F_in
        self.F_out = F_out 
        self.B1 = b1 
        self.B2 = b2
...
class sccnn_conv_no_x0_to_node(nn.Module):
    def __init__(self, F_in, F_out, b1, b2, l0, l1l, l1u, l2, d1,d2,d3,d5, k00,k0p,k1n,k11,k12,k1p,k2n,k22, sigma):
        """
        F_in: number of input features per layer 
        F_out: number of output features per layer
        ...
        n: stands for negative, denoting the lower simplex order
        """
        super(sccnn_conv_no_x0_to_node, self).__init__()
        self.F_in = F_in
        self.F_out = F_out 
        self.B1 = b1 
        self.B2 = b2
...
class sccnn_conv_no_x0_sc1(nn.Module):
    def __init__(self, F_in, F_out, b1, b2, l0, l1l, l1u, l2, d1,d2,d3,d5, k00,k0p,k1n,k11,k12,k1p,k2n,k22, sigma):
        """
        F_in: number of input features per layer 
        F_out: number of output features per layer
        ...
        n: stands for negative, denoting the lower simplex order
        """
        super(sccnn_conv_no_x0_sc1, self).__init__()
        self.F_in = F_in
        self.F_out = F_out 
        self.B1 = b1 
        self.B2 = b2
...
class sccnn_conv_no_x0_to_node_sc1(nn.Module):
    def __init__(self, F_in, F_out, b1, b2, l0, l1l, l1u, l2, d1,d2,d3,d5, k00,k0p,k1n,k11,k12,k1p,k2n,k22, sigma):
        """
        F_in: number of input features per layer 
        F_out: number of output features per layer
        ...
        n: stands for negative, denoting the lower simplex order
        """
        super(sccnn_conv_no_x0_to_node_sc1, self).__init__()
        self.F_in = F_in
        self.F_out = F_out 
        self.B1 = b1 
        self.B2 = b2
...
class sccnn_conv_no_x1_sc1(nn.Module):
    def __init__(self, F_in, F_out, b1, b2, l0, l1l, l1u, l2, d1,d2,d3,d5, k00,k0p,k1n,k11,k12,k1p,k2n,k22, sigma):
        """
        F_in: number of input features per layer 
        F_out: number of output features per layer
        ...
        n: stands for negative, denoting the lower simplex order
        """
        super(sccnn_conv_no_x1_sc1, self).__init__()
        self.F_in = F_in
        self.F_out = F_out 
        self.B1 = b1 
        self.B2 = b2
...
class sccnn_conv_no_x1_to_node_sc1(nn.Module):
    def __init__(self, F_in, F_out, b1, b2, l0, l1l, l1u, l2, d1,d2,d3,d5, k00,k0p,k1n,k11,k12,k1p,k2n,k22, sigma):
        """
        F_in: number of input features per layer 
        F_out: number of output features per layer
        ...
        n: stands for negative, denoting the lower simplex order
        """
        super(sccnn_conv_no_x1_to_node_sc1, self).__init__()
        self.F_in = F_in
        self.F_out = F_out 
        self.B1 = b1 
        self.B2 = b2
...
'''sccnn stability_rlt_model based on the relative perturbation models for projection matrices'''
class sccnn_conv_stability_rlt_model(nn.Module):
    def __init__(self, F_in, F_out, b1, b2, l0, l1l, l1u, l2, p01,p10,p12,p21, k00,k0p,k1n,k11,k12,k1p,k2n,k22, sigma):
        """
        F_in: number of input features per layer 
        F_out: number of output features per layer
        p: stands for positive, denoting the upper simplex oreder
        n: stands for negative, denoting the lower simplex order
        """
        super(sccnn_conv_stability_rlt_model, self).__init__()
        self.F_in = F_in
        self.F_out = F_out 
        self.B1 = b1 
        self.B2 = b2
