...
'''
this is the script to implement bunch-node when sc is of order 1
'''
import torch
...
def main():
    ...
    parser.add_argument("-m","--model_name",help="the model name", type=str, default='bunch_node_no_b2')
    ...
    if args.model_name in ['bunch_node_no_b2']:
