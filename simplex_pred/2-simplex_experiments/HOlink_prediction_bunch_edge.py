...
'''
this is the script to implement bunch-edge when sc is of order 2
'''
import torch
...
from bunch_einsum import bunch
'''filter'''
# from bunch_einsum_id import bunch
...
def main():
    ...
    parser.add_argument("-m","--model_name",help="the model name", type=str, default='bunch_edge')
    ...
    model = bunch(F_in=1, F_intermediate=F_intermediate, F_out=hidden_features, b1=B1, b2=B2_train, l0=L0, l1=L1, l2=L2, d1=D1, d2=D2, d3=D3, d5=D5, sigma=sigma, model_name=model_name)
