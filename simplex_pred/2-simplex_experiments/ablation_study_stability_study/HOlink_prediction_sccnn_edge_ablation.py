...
os.chdir(path)
'''
implement the sccnn-edge for ablation study: see sccnn_conv_einsum.py for the definition
'''
...
def main():
    ...
    parser.add_argument("-m","--model_name",help="the model name", type=str, default='sccnn_edge_no_b2_no_node_to_edge')
    ...
    if args.model_name == 'sccnn_edge_no_b2_no_node_to_edge':
    ...
    if model_name in ['sccnn_edge','sccnn_edge_ebli','sccnn_edge_no_b2','sccnn_edge_no_b2_no_node_to_edge']:
