...
def main():
    ...
    parser.add_argument("-m","--model_name",help="the model name", type=str, default='sccnn_tri_sc_2')
    ...
    if args.model_name == 'sccnn_tri_sc_2':
    ...
    if model_name in ['sccnn_tri','sccnn_tri_ebli','sccnn_tri_no_b3']:
    ...
    if model_name in ['sccnn_tri_sc_2']:
