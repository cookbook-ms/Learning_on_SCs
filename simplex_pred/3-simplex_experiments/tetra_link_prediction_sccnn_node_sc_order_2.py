...
def main():
    ...
    parser.add_argument("-m","--model_name",help="the model name", type=str, default='sccnn_node_no_b3')
    ...
    if args.model_name == 'sccnn_node_no_b3':
    ...
    if model_name in ['sccnn_node','sccnn_node_ebli','sccnn_node_no_b3']:
