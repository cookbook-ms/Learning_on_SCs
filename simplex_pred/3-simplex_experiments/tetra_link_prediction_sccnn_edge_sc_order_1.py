...
def main():
    ...
    parser.add_argument("-m","--model_name",help="the model name", type=str, default='sccnn_edge_no_b2')
    ...
    if args.model_name == 'sccnn_edge_no_b2':
    ...
    if model_name in ['sccnn_edge','sccnn_edge_ebli','sccnn_edge_no_b2','sccnn_edge_no_tetra']:
    ...
    if model_name in ['sccnn_edge','sccnn_edge_ebli','sccnn_edge_no_b2']:
