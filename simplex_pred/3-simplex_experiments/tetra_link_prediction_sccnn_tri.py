...
def main():
    ...
    parser.add_argument("-m","--model_name",help="the model name", type=str, default='sccnn_tri')
    ...
    if model_name in ['sccnn_tri','sccnn_tri_ebli']:
    ...
    for e in range(args.epochs):
        ...
        forward
        ''' 
        h_node,h_edge,h,h_tetra = model(f_input)
        '''
