...
def main():
    ...
    L2, L2l, L2u = L2.to(device), L2l.to(device), L2u.to(device) 
    model = scnn(F_in=1, F_intermediate=F_intermediate, F_out=hidden_features, K=K, K1=K1, K2=K2, laplacian=L2, laplacian_l=L2l, laplacian_u=L2u, sigma=sigma, model_name=model_name)
